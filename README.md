...
Dự án này được bảo hộ theo giấy phép **MIT License** - Bạn có thể tự do chia sẻ, chỉnh sửa và sử dụng cho mục đích cá nhân hoặc thương mại.

> *"Cách tốt nhất để dự đoán tương lai là tự tay lập trình ra nó."* Cố lên các bạn!
